...
import {
  ...
  Linkedin,
  Mail,
} from "lucide-react"; // You can replace with any icon library
  ...
  return (
    <footer className="bg-white ">
      ...
      <div className="relative max-w-7xl mx-auto py-20 px-6 grid grid-cols-1 md:grid-cols-4 gap-10 items-start">
        ...
        {/* Contact Info */}
        <div>
          <h3 className="font-semibold text-orange-600 mb-2">Contact Info</h3>
        ...
        {/* Address */}
        <div>
          <h3 className="font-semibold text-orange-600 mb-2">Address</h3>
          <ul className="space-y-1 text-green-700">
            <li>Lorem ipsum</li>
            <li>Lorem ipsum</li>
            <li>Lorem ipsum</li>
        ...
        {/* Company Info */}
        <div>
          <h3 className="font-semibold text-orange-600 mb-2">Company</h3>
          <ul className="space-y-1 text-green-700">
