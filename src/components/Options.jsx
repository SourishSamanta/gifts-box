  ...
  return (
    <section className=' w-full min-h-screen'>
      <div className='w-full min-h-[50vh]  flex items-center justify-center gap-10'>
        ...
        <div className='cherry w-[25%] h-[338px] rounded-3xl text-white text-3xl bg-[url(/assets/kidsbg.png)] bg-cover  flex items-center justify-center'>
          Kids
        </div>

        <div className='cherry w-[25%] h-[338px] rounded-3xl text-white text-3xl bg-[url(/assets/adultsbg.png)] bg-cover flex items-center justify-center'>
          Adults
        </div>

        <div className='cherry w-[25%] h-[338px] rounded-3xl text-white text-3xl bg-[url(/assets/corporatebg.png)] bg-cover flex items-center justify-center'>
          Corporate
        </div>
